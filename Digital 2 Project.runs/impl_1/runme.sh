...
HD_PWD='C:/Users/muhammad_osama/Downloads/Downloads/finalProject/digital 2 project/digital 2 project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_module.tcl -notrace

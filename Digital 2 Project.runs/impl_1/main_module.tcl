...
set rc [catch {
  ...
  add_files -quiet {{C:/Users/muhammad_osama/Downloads/Downloads/finalProject/digital 2 project/digital 2 project.runs/synth_1/main_module.dcp}}
  ...
  link_design -top main_module -part xc7a35tcpg236-1
  write_hwdef -file main_module.hwdef
...
set rc [catch {
  ...
  catch { report_drc -file main_module_drc_routed.rpt -pb main_module_drc_routed.pb -rpx main_module_drc_routed.rpx }
  catch { report_methodology -file main_module_methodology_drc_routed.rpt -rpx main_module_methodology_drc_routed.rpx }
  ...
  catch { report_power -file main_module_power_routed.rpt -pb main_module_power_summary_routed.pb -rpx main_module_power_routed.rpx }
  catch { report_route_status -file main_module_route_status.rpt -pb main_module_route_status.pb }
  catch { report_clock_utilization -file main_module_clock_utilization_routed.rpt }
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force main_module_routed_error.dcp
...
set rc [catch {
  ...
  catch { write_mem_info -force main_module.mmi }
  write_bitstream -force -no_partial_bitfile main_module.bit 
  catch { write_sysdef -hwdef main_module.hwdef -bitfile main_module.bit -meminfo main_module.mmi -file main_module.sysdef }

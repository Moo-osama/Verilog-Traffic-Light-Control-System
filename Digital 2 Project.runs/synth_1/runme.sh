...
HD_PWD='C:/Users/muhammad_osama/Downloads/Downloads/finalProject/digital 2 project/digital 2 project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_module.tcl
